                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_asc_disabled">访问用户</th>
                                <th class="sorting_asc sorting_asc_disabled">访问时间</th>
                                <th class="sorting_desc sorting_desc_disabled">访问IP</th>
                                <th class="sorting sorting_desc_disabled">资源URL</th>
                                <th class="text-center sorting_desc_disabled">执行时间</th>
                                <th class="text-center sorting_desc_disabled">访问方法</th>
                            </tr>
                            </thead>
                            <tbody>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/syslog/findAll?pageNum=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a></li>
                            <li>
